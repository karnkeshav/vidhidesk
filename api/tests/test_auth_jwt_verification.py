...
def _mock_env(monkeypatch):
    ...
    # as of the security review's round 2) -- this file is about local
    # JWT/JWKS verification specifically, so both are given a permissive
    # fake rather than hitting a real (and here, unconfigured) Supabase
